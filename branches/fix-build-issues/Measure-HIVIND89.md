# HIV.IND.89 HCV positivity, HIV-positive clients - WHO SMART Guidelines - HIV v0.4.4
...
## Measure: HIV.IND.89 HCV positivity, HIV-positive clients (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/Measure/HIVIND89 | *Version*:0.4.4 |
| Draft as of 2024-08-18 | *Computable Name*:HIVIND89 |
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: HIV.IND.89.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#hivind89logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: HIV.IND.89.DEN**Description**:Number of people living with HIV who were tested for HCV during the reporting period**Logic Definition**:[Denominator](#hivind89logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: HIV.IND.89.NUM**Description**:Number of people living with HIV newly identified with a positive HCV test (HCV antibody, HCV RNA (PCR) or HCV core antigen) during the reporting period**Logic Definition**:[Numerator](#hivind89logic-numerator)
* Knowledge Artifact Metadata: Measure Logic
* Knowledge Artifact Metadata: Primary Library
  * ?: [HIV.IND.89 Logic](Library-HIVIND89Logic.md)
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Observation**Profile(s)**:[Observation](http://hl7.org/fhir/R4/observation.html)**Must Support Elements**: code, status, value, effective, effective.low**Code Filter(s)**:**Path**: code**Code**: 
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND89Logic
* Knowledge Artifact Metadata: ````/** * Numerator * * Definition: Number of people living with HIV newly identified with a positive HCV test (HCV antibody, HCV RNA (PCR) or HCV core antigen) during the reporting period * Calculation: COUNT of clients with "HIV status"='HIV-positive' AND with "HCV test date" in the reporting period AND "HCV test result"='HCV positive' */ define "Numerator": HIE."Has HIV-positive Status" and exists(HIE."Positive D.DE171")````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
* Knowledge Artifact Metadata: ````/* End of HBV treatment TDF start date */ /* @dataElement: HIV.D.DE169 - HCV test date @activity: HIV.D12 Determine recommended screenings and tests @description: Date client was tested for hepatitis C virus (HCV antibody, HCV RNA or HCV core antigen) */ define "HCV test date D.DE169": "HCV test result D.DE170" O return O.effective.toInterval().low````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND89Logic
* Knowledge Artifact Metadata: ````/** * Denominator * * Definition: Number of people living with HIV who were tested for HCV during the reporting period * Calculation: COUNT of clients with "HIV status"='HIV-positive' AND with "HCV test date" in the reporting period */ define "Denominator": HIE."Has HIV-positive Status" and exists(HIE."HCV test date D.DE169")````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND89Logic
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "type" : "Observation",
      "profile" : ["http://hl7.org/fhir/StructureDefinition/Observation"],
      "mustSupport" : ["code", "status", "value", "effective", "effective.low"],
      "codeFilter" : [{
        "path" : "code",
        "code" : [{
          "system" : "http://smart.who.int/hiv/CodeSystem/HIVConcepts",
