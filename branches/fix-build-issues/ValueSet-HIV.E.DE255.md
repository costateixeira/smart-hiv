...
| Active as of 2026-03-03 | *Computable Name*:HIVEDE255 |
...
##### Asymptomatic bacteriuria (ASB) test result ValueSet Schema API

JSON Schema for Asymptomatic bacteriuria (ASB) test result ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.

**Version:** 1.0.0

## Endpoints

### GET /ValueSet-HIV.E.DE255.schema.json

#### JSON Schema definition for the enumeration ValueSet-HIV.E.DE255

This endpoint serves the JSON Schema definition for the enumeration ValueSet-HIV.E.DE255.

## Schema Definition

### ValueSet-HIV.E.DE255

**Description:** JSON Schema for Asymptomatic bacteriuria (ASB) test result ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.
