# HIV.IND.75 Gonorrhoea treatment coverage, HIV-positive clients - WHO SMART Guidelines - HIV v0.4.4
...
## Measure: HIV.IND.75 Gonorrhoea treatment coverage, HIV-positive clients (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/Measure/HIVIND75 | *Version*:0.4.4 |
| Draft as of 2024-08-18 | *Computable Name*:HIVIND75 |
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: HIV.IND.75.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#hivind75logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: HIV.IND.75.DEN**Description**:Number of people living with HIV who tested positive for gonorrhoea during the reporting period**Logic Definition**:[Denominator](#hivind75logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: HIV.IND.75.NUM**Description**:Number of people living with HIV who tested positive for gonorrhoea and were treated based on national guidelines during the reporting period**Logic Definition**:[Numerator](#hivind75logic-numerator)
* Knowledge Artifact Metadata: Measure Logic
* Knowledge Artifact Metadata: Primary Library
  * ?: [HIV.IND.75 Logic](Library-HIVIND75Logic.md)
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND75Logic
* Knowledge Artifact Metadata: ````/** * Numerator * * Definition: Number of people living with HIV who tested positive for gonorrhoea and were treated based on national guidelines during the reporting period * Calculation: COUNT of clients with "HIV status"='HIV-positive' AND "Gonorrhoea test date" in the reporting period AND "Gonorrhoea test result"='Positive' AND "Gonorrhoea treatment start date" in the reporting period */ define "Numerator": HIE."Has HIV-positive Status" and HIE."Positive B.DE257" and HIE."Gonorrhoea treatment start date B.DE260"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND75Logic
* Knowledge Artifact Metadata: ````/** * Denominator * * Definition: Number of people living with HIV who tested positive for gonorrhoea during the reporting period * Calculation: COUNT of clients with "HIV status"='HIV-positive' AND "Gonorrhoea test date" in the reporting period AND "Gonorrhoea test result"='Positive' */ define "Denominator": HIE."Has HIV-positive Status" and HIE."Positive B.DE257"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND75Logic
