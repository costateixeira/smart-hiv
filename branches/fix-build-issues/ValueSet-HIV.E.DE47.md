...
| Active as of 2026-03-03 | *Computable Name*:HIVEDE47 |
...
##### Pregnancy outcome ValueSet Schema API

JSON Schema for Pregnancy outcome ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.

**Version:** 1.0.0

## Endpoints

### GET /ValueSet-HIV.E.DE47.schema.json

#### JSON Schema definition for the enumeration ValueSet-HIV.E.DE47

This endpoint serves the JSON Schema definition for the enumeration ValueSet-HIV.E.DE47.

## Schema Definition

### ValueSet-HIV.E.DE47

**Description:** JSON Schema for Pregnancy outcome ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.
