# HIV.IND.70 Gonorrhoea testing coverage, HIV prevention services - WHO SMART Guidelines - HIV v0.4.4
...
## Measure: HIV.IND.70 Gonorrhoea testing coverage, HIV prevention services (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/Measure/HIVIND70 | *Version*:0.4.4 |
| Draft as of 2024-08-18 | *Computable Name*:HIVIND70 |
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: HIV.IND.70.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#hivind70logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: HIV.IND.70.DEN**Description**:Number of people attending HIV prevention services during the reporting period**Logic Definition**:[Denominator](#hivind70logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: HIV.IND.70.NUM**Description**:Number of people attending HIV prevention services tested for gonorrhoea (using a molecular test, culture or POC test) | **Logic Definition**:[Numerator](#hivind70logic-numerator)
* Knowledge Artifact Metadata: Measure Logic
* Knowledge Artifact Metadata: Primary Library
  * ?: [HIV.IND.70 Logic](Library-HIVIND70Logic.md)
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND70Logic
* Knowledge Artifact Metadata: ````/** * Numerator * * Definition: Number of people attending HIV prevention services tested for gonorrhoea (using a molecular test, culture or POC test) | * Calculation: COUNT of clients with "Gonorrhoea test date" in the reporting period */ define "Numerator": exists(HIE."Gonorrhoea test result B.DE256") and exists(HIE."Date accessed HIV prevention intervention")````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND70Logic
