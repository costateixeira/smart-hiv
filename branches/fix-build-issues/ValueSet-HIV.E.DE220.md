...
| Active as of 2026-03-03 | *Computable Name*:HIVEDE220 |
...
##### Test result of syphilis assay 1 repeated ValueSet Schema API

JSON Schema for Test result of syphilis assay 1 repeated ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.

**Version:** 1.0.0

## Endpoints

### GET /ValueSet-HIV.E.DE220.schema.json

#### JSON Schema definition for the enumeration ValueSet-HIV.E.DE220

This endpoint serves the JSON Schema definition for the enumeration ValueSet-HIV.E.DE220.

## Schema Definition

### ValueSet-HIV.E.DE220

**Description:** JSON Schema for Test result of syphilis assay 1 repeated ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.
