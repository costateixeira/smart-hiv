# Location ARV drugs received prior to enrolment ValueSet - WHO SMART Guidelines - HIV v0.4.4
...
## ValueSet: Location ARV drugs received prior to enrolment ValueSet (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/ValueSet/HIV.D.DE63 | *Version*:0.4.4 |
| Active as of 2026-03-03 | *Computable Name*:HIVDDE63 |
...
```json
{
  ...
  "extension" : [{
    ...
    "valueMarkdown" : "This should be a context-specific list of facilities providing ARV drugs"
  }],
