# HIV.IND.91 HCV treatment among people living with HIV - WHO SMART Guidelines - HIV v0.4.4
...
## Measure: HIV.IND.91 HCV treatment among people living with HIV (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/Measure/HIVIND91 | *Version*:0.4.4 |
| Draft as of 2024-08-18 | *Computable Name*:HIVIND91 |
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: HIV.IND.91.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#hivind91logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: HIV.IND.91.DEN**Description**:Number of people living with HIV diagnosed with HCV during the reporting period**Logic Definition**:[Denominator](#hivind91logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: HIV.IND.91.NUM**Description**:Number of people living with HIV newly started on HCV treatment during the reporting period**Logic Definition**:[Numerator](#hivind91logic-numerator)
* Knowledge Artifact Metadata: Measure Logic
* Knowledge Artifact Metadata: Primary Library
  * ?: [HIV.IND.91 Logic](Library-HIVIND91Logic.md)
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
* Knowledge Artifact Metadata: ````/* End of Indeterminate D.DE173 */ /* @dataElement: HIV.D.DE175 - HCV treatment start date @activity: HIV.D12 Determine recommended screenings and tests @description: Date when client started treatment for hepatitis C virus (HCV) */ define "HCV treatment start date": exists Elements."HCV medicine type" MS where start of MS.effective.toInterval() during "Measurement Period"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND91Logic
* Knowledge Artifact Metadata: ````/** * Numerator * THIS REFERS TO ANY MEDICATION BUT ABOVE DESCRIPTION ONLY SAYS DIRECT ACTING ANTIRETROVIRALS * Definition: Number of people living with HIV newly started on HCV treatment during the reporting period * Calculation: COUNT of clients with "HIV status"='HIV-positive' AND "HCV test date" in the reporting period AND "HCV test result"='HCV positive' AND "HCV treatment start date" in the reporting period */ define "Numerator": HIE."Has HIV-positive Status" and exists(HIE."Positive D.DE171" O where O.effective.toInterval() during "Measurement Period") and HIE."HCV treatment start date"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND91Logic
* Knowledge Artifact Metadata: ````/** * Denominator * * Definition: Number of people living with HIV diagnosed with HCV during the reporting period * Calculation: COUNT of clients with "HIV status"='HIV-positive' AND "HCV test date" in the reporting period AND "HCV test result"='HCV positive' */ define "Denominator": HIE."Has HIV-positive Status" and exists(HIE."Positive D.DE171" O where O.effective.toInterval() during "Measurement Period")````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND91Logic
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "/**\n * Numerator\n * THIS REFERS TO ANY MEDICATION BUT ABOVE DESCRIPTION ONLY SAYS DIRECT ACTING ANTIRETROVIRALS\n * Definition: Number of people living with HIV newly started on HCV treatment during the reporting period\n * Calculation: COUNT of clients with \"HIV status\"='HIV-positive' AND \"HCV test date\" in the reporting period AND \"HCV test result\"='HCV positive' AND \"HCV treatment start date\" in the reporting period\n */\n\ndefine \"Numerator\":\n  HIE.\"Has HIV-positive Status\" and\n  exists(HIE.\"Positive D.DE171\" O where O.effective.toInterval() during \"Measurement Period\") and\n  HIE.\"HCV treatment start date\""
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 11
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "/**\n * Denominator\n *\n * Definition: Number of people living with HIV diagnosed with HCV during the reporting period\n * Calculation: COUNT of clients with \"HIV status\"='HIV-positive' AND \"HCV test date\" in the reporting period AND \"HCV test result\"='HCV positive'\n */\n\ndefine \"Denominator\":\n  HIE.\"Has HIV-positive Status\" and\n  exists(HIE.\"Positive D.DE171\" O where O.effective.toInterval() during \"Measurement Period\")"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 12
