...
| Active as of 2026-03-03 | *Computable Name*:HIVGDE22 |
...
##### Reason Hepatitis B test not conducted ValueSet Schema API

JSON Schema for Reason Hepatitis B test not conducted ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.

**Version:** 1.0.0

## Endpoints

### GET /ValueSet-HIV.G.DE22.schema.json

#### JSON Schema definition for the enumeration ValueSet-HIV.G.DE22

This endpoint serves the JSON Schema definition for the enumeration ValueSet-HIV.G.DE22.

## Schema Definition

### ValueSet-HIV.G.DE22

**Description:** JSON Schema for Reason Hepatitis B test not conducted ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.
