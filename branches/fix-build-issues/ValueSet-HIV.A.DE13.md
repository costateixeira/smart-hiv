# Country of birth ValueSet - WHO SMART Guidelines - HIV v0.4.4
...
## ValueSet: Country of birth ValueSet (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/ValueSet/HIV.A.DE13 | *Version*:0.4.4 |
| Active as of 2026-03-03 | *Computable Name*:HIVADE13 |
...
```json
{
  ...
  "extension" : [{
    ...
    "valueMarkdown" : "This should be a context-specific list of countries where a patient might be born"
  }],
