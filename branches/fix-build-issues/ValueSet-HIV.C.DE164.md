...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/ValueSet/HIV.C.DE164 | *Version*:0.4.4 |
| Active as of 2026-03-03 | *Computable Name*:HIVCDE164 |
...
### GET /ValueSet-HIV.C.DE164.schema.json

#### JSON Schema definition for the enumeration ValueSet-HIV.C.DE164

This endpoint serves the JSON Schema definition for the enumeration ValueSet-HIV.C.DE164.

## Schema Definition

### ValueSet-HIV.C.DE164
...
```json
{
  ...
  "url" : "http://smart.who.int/hiv/ValueSet/HIV.C.DE164",
  "version" : "0.4.4",
  "name" : "HIVCDE164",
