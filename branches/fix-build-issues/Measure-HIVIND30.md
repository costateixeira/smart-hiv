# HIV.IND.30 New ART patients - WHO SMART Guidelines - HIV v0.4.4
...
## Measure: HIV.IND.30 New ART patients (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/Measure/HIVIND30 | *Version*:0.4.4 |
| Draft as of 2024-08-18 | *Computable Name*:HIVIND30 |
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: HIV.IND.30.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#hivind30logic-initial-population)
* Knowledge Artifact Metadata: Measure Population
  * ?: **ID**: HIV.IND.30.MP**Description**:Measure Population**Logic Definition**:[Measure Population](#hivind30logic-measure-population)
* Knowledge Artifact Metadata: Measure Observation
  * ?: **ID**: HIV.IND.30.MO**Description**:Measure Observation**Logic Definition**:[Measure Observation](#hivind30logic-measure-observation)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: HIV.IND.30.S
* Knowledge Artifact Metadata: Measure Logic
* Knowledge Artifact Metadata: Primary Library
  * ?: [HIV.IND.30 Logic](Library-HIVIND30Logic.md)
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND30Logic
* Knowledge Artifact Metadata: ````define "Measure Population": HIE."Has HIV-positive Status" and (date from start of HE."First On ART".effective.toInterval() during "Measurement Period")````
* Knowledge Artifact Metadata:  Logic Definition
