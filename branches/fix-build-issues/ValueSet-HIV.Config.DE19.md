# Other priority populations ValueSet - WHO SMART Guidelines - HIV v0.4.4
...
## ValueSet: Other priority populations ValueSet (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/ValueSet/HIV.Config.DE19 | *Version*:0.4.4 |
| Active as of 2026-03-03 | *Computable Name*:HIVConfigDE19 |
...
```json
{
  ...
  "extension" : [{
    ...
    "valueMarkdown" : "This should be a context-specific list of other priority populations"
  }],
