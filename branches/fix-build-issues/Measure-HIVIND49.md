# HIV.IND.49 TB symptom-screened positive among new ART patients - WHO SMART Guidelines - HIV v0.4.4
...
## Measure: HIV.IND.49 TB symptom-screened positive among new ART patients (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/Measure/HIVIND49 | *Version*:0.4.4 |
| Draft as of 2024-08-18 | *Computable Name*:HIVIND49 |
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: HIV.IND.49.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#hivind49logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: HIV.IND.49.DEN**Description**:Number of people living with HIV newly initiated on ART during the reporting period who were screened for TB symptoms**Logic Definition**:[Denominator](#hivind49logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: HIV.IND.49.NUM**Description**:Number of people living with HIV newly initiated on ART who screened positive for TB symptoms**Logic Definition**:[Numerator](#hivind49logic-numerator)
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Procedure**Profile(s)**:[Procedure](http://hl7.org/fhir/R4/procedure.html)**Must Support Elements**: status, category, performed
* Knowledge Artifact Metadata: Data Requirement
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
* Knowledge Artifact Metadata: ````/* End of TB screening result */ /* @dataElement: HIV.D.DE987 - Screen positive for TB @activity: HIV.D4 Screen for TB @description: Screening result was positive for tuberculosis (TB) */ define "Screen positive for TB": exists Elements."Screen positive for TB" O where O.effective.toInterval() during "Measurement Period"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND49Logic
* Knowledge Artifact Metadata: ````/** * Numerator * * Definition: Number of people living with HIV newly initiated on ART who screened positive for TB symptoms * Calculation: COUNT of clients with "HIV status"='HIV-positive' AND with "ART start type"='First-time user of ART' AND with "ART start date" in the reporting period AND "TB screening date" in the reporting period AND "TB screening result"='Screen positive for TB' */ define "Numerator": HIE."Has HIV-positive Status" and (start of First(HE."First-time user of ART").effective.toInterval() during "Measurement Period") and HIE."Screen positive for TB"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVElements
* Knowledge Artifact Metadata: ````/* End of Inconclusive D.DE989 */ /* @dataElement: HIV.D.DE990 - TB screening date @activity: HIV.D4 Screen for TB @description: Date the TB screening was conducted */ define "TB screening date": [Procedure] P where P.status = 'completed' and P.category ~ Concepts."TB diagnostic test category"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
* Knowledge Artifact Metadata: ````/* End of Inconclusive D.DE989 */ /* @dataElement: HIV.D.DE990 - TB screening date @activity: HIV.D4 Screen for TB @description: Date the TB screening was conducted */ define "TB screening date": exists (Elements."TB screening date" P where P.performed.toInterval() during "Measurement Period")````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND49Logic
* Knowledge Artifact Metadata: ````/** * Denominator * * Definition: Number of people living with HIV newly initiated on ART during the reporting period who were screened for TB symptoms * Calculation: COUNT of clients with "HIV status"='HIV-positive' AND with "ART start type"='First-time user of ART' AND with "ART start date" in the reporting period AND "TB screening date" in the reporting period */ define "Denominator": HIE."Has HIV-positive Status" and (start of First(HE."First-time user of ART").effective.toInterval() during "Measurement Period") and HIE."TB screening date"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND49Logic
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      ...
      "mustSupport" : ["status", "category", "performed"]
    },
    {
      "type" : "Patient",
