# HIV.IND.45 TPT completion - WHO SMART Guidelines - HIV v0.4.4
...
## Measure: HIV.IND.45 TPT completion (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/Measure/HIVIND45 | *Version*:0.4.4 |
| Draft as of 2024-08-18 | *Computable Name*:HIVIND45 |
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: HIV.IND.45.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#hivind45logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: HIV.IND.45.DEN**Description**:Number of ART patients who initiated any course of TPT during the previous reporting period**Logic Definition**:[Denominator](#hivind45logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: HIV.IND.45.NUM**Description**:Number of ART patients who completed a course of TPT during the reporting period**Logic Definition**:[Numerator](#hivind45logic-numerator)
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set ART regimen Choices**Resource**:[ART regimen ValueSet](ValueSet-HIV.D.DE90.md)**Canonical URL**:http://smart.who.int/hiv/ValueSet/HIV.D.DE90
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set TPT regimen type Choices**Resource**:[TPT regimen type ValueSet](ValueSet-HIV.D.DE1028.md)**Canonical URL**:http://smart.who.int/hiv/ValueSet/HIV.D.DE1028
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: MedicationStatement**Profile(s)**:[MedicationStatement](http://hl7.org/fhir/R4/medicationstatement.html)**Must Support Elements**: medication, effective, status, coding, code**Code Filter(s)**:**Path**: medication**ValueSet**:[ART regimen ValueSet](ValueSet-HIV.D.DE90.md)
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: MedicationStatement**Profile(s)**:[MedicationStatement](http://hl7.org/fhir/R4/medicationstatement.html)**Must Support Elements**: medication, effective, status, coding, code**Code Filter(s)**:**Path**: medication**ValueSet**:[TPT regimen type ValueSet](ValueSet-HIV.D.DE1028.md)
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: MedicationStatement**Profile(s)**:[MedicationStatement](http://hl7.org/fhir/R4/medicationstatement.html)**Must Support Elements**: medication.reference, effective, status, medication, coding, code
* Knowledge Artifact Metadata: Data Requirement
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVElements
* Knowledge Artifact Metadata: ````/* On ART - includes "On ART - HIV.B.DE47" and "On ART - HIV.B.DE48" */ define "ART Medication Statement": [MedicationStatement: Concepts."ART regimen Choices"] MS sort by start of effective.toInterval()````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
* Knowledge Artifact Metadata: ````// HIV Status // ART Status define "ART Medication Statement": Elements."ART Medication Statement" MS where MS.effective.toInterval() during "Measurement Period" sort by start of effective.toInterval()````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
* Knowledge Artifact Metadata: ````define "On ART": exists "ART Medication Statement"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVElements
* Knowledge Artifact Metadata: ````/* End of C reactive protein test result */ /* @dataElement: HIV.D.DE1028 - TPT regimen type @activity: HIV.D4 Screen for TB @description: Type of TPT regimen the client is currently on */ define "TPT regimen": [MedicationStatement: Concepts."TPT regimen type Choices"] MS where MS.status in { 'active', 'completed' }````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
* Knowledge Artifact Metadata: ````define "TB preventive treatment TPT completed in measurement period": Elements."TPT regimen" MS where start of MS.effective.toInterval() in "Measurement Period" and MS.status = 'completed'````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND45Logic
* Knowledge Artifact Metadata: ````/** * Numerator * * Definition: Number of ART patients who completed a course of TPT during the reporting period * Calculation: COUNT of clients with "HIV status"='HIV-positive' AND "On ART"=True AND "TB preventive treatment (TPT) start date" in the previous period AND "TB preventive treatment (TPT) status"='Completed' */ define "Numerator": HIE."Has HIV-positive Status" and HIE."On ART" and exists(HIE."TB preventive treatment TPT completed in measurement period")````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVElements
* Knowledge Artifact Metadata: ````/* End of Date of TB diagnosis */ /* @dataElement: HIV.D.DE954 - TB preventive treatment TPT start date @activity: HIV.D8 Capture or update client history @description: The date on which the client began taking TPT */ // TODO: Replace placeholder with relevant CQL logic define "TB preventive treatment TPT start date": "TPT regimen" MS return start of MS.effective.toInterval()````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
* Knowledge Artifact Metadata: ````define "TB preventive treatment TPT start date in previous measurement period": Elements."TB preventive treatment TPT start date" D where D before (end of "Measurement Period" - duration in days of "Measurement Period") and D after (start of "Measurement Period" - duration in days of "Measurement Period")````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND45Logic
* Knowledge Artifact Metadata: ````/** * Denominator * * Definition: Number of ART patients who initiated any course of TPT during the previous reporting period * Calculation: COUNT of clients with "HIV status"='HIV-positive' AND "On ART"=True AND "TB preventive treatment (TPT) start date" in the prior reporting period */ define "Denominator": HIE."Has HIV-positive Status" and HIE."On ART" and exists(HIE."TB preventive treatment TPT start date in previous measurement period")````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND45Logic
* Knowledge Artifact Metadata: ````/** * Indicator Definition */ /* Populations */ /* *Initial Population */ define "Initial Population": true````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
* Knowledge Artifact Metadata: ````define "TPT regimen": Elements."TPT regimen" MS where MS.effective.toInterval() during "Measurement Period"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
* Knowledge Artifact Metadata: ````define "TPT regimen type": "TPT regimen" MS return Common.ExtractMedicationCode(MS.medication)````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
* Knowledge Artifact Metadata: ````define "ART Duration in Months": "ART Medication Statement" MS return duration in months of MS.effective.toInterval()````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
* Knowledge Artifact Metadata: ````define "By ART initiation": case when Sum("ART Duration in Months") < 12 then '<12 months on ART' when Sum("ART Duration in Months") >= 12 then '12+ months on ART' else 'Unknown' end````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND45Logic
* Knowledge Artifact Metadata: ````/* * Combined stratifiers */ define "Stratification": HIE."By Administrative Gender Stratifier".code + ':' + HIE."By Age Stratifier" + ':' + Combine(HIE."TPT regimen type".coding.code) + ':' + HIE."By ART initiation" + ':' + HIE."By Geographic Region Stratifier"````
* Knowledge Artifact Metadata:  Logic Definition
...
* Knowledge Artifact Metadata: ````/** * @description Takes a choice between a Medication and a CodeableConcept and returns just the code of the medication */ define function ExtractMedicationCode(choice Choice<FHIR.CodeableConcept, FHIR.Reference>): case when choice is FHIR.CodeableConcept then choice as FHIR.CodeableConcept when choice is FHIR.Reference then First([Medication] M where M.id = Last(Split(choice.reference, '/')) return M.code as FHIR.CodeableConcept) else Message(null as FHIR.CodeableConcept, true, '1', 'Error', 'Cannot compute a medication code') // TODO: I'm sure that this is supported somehow? end````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**FHIRHelpers
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "ART Medication Statement"
      },
      {
        "url" : "statement",
        "valueString" : "/* On ART - includes \"On ART - HIV.B.DE47\" and \"On ART - HIV.B.DE48\" */\ndefine \"ART Medication Statement\":\n  [MedicationStatement: Concepts.\"ART regimen Choices\"] MS\n  sort by start of effective.toInterval()"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 6
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TB preventive treatment TPT completed in measurement period"
      },
      {
        "url" : "statement",
        "valueString" : "define \"TB preventive treatment TPT completed in measurement period\":\n  Elements.\"TPT regimen\" MS\n    where start of MS.effective.toInterval() in \"Measurement Period\"\n      and MS.status = 'completed'"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 10
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "define \"TPT regimen\":\n  Elements.\"TPT regimen\" MS\n    where MS.effective.toInterval() during \"Measurement Period\""
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 19
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TPT regimen type"
      },
      {
        "url" : "statement",
        "valueString" : "define \"TPT regimen type\":\n  \"TPT regimen\" MS\n  return Common.ExtractMedicationCode(MS.medication)"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 20
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "By ART initiation"
      },
      {
        "url" : "statement",
        "valueString" : "define \"By ART initiation\":\n  case\n    when Sum(\"ART Duration in Months\") < 12 then '<12 months on ART'\n    when Sum(\"ART Duration in Months\") >= 12 then '12+ months on ART'\n    else 'Unknown'\n  end"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 22
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "ExtractMedicationCode"
      },
      {
        "url" : "statement",
    ...
    {
      "type" : "depends-on",
      "display" : "Value set ART regimen Choices",
      "resource" : "http://smart.who.int/hiv/ValueSet/HIV.D.DE90"
    },
    {
      "type" : "depends-on",
      "display" : "Value set TPT regimen type Choices",
      "resource" : "http://smart.who.int/hiv/ValueSet/HIV.D.DE1028"
    }],
    "parameter" : [{
    ...
    },
    {
      ...
      "mustSupport" : ["medication", "effective", "status", "coding", "code"],
      "codeFilter" : [{
        "path" : "medication",
