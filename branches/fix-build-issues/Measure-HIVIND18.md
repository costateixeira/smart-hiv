# HIV.IND.18 People living with HIV who know their HIV status (first 95) - WHO SMART Guidelines - HIV v0.4.4
...
## Measure: HIV.IND.18 People living with HIV who know their HIV status (first 95) (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/Measure/HIVIND18 | *Version*:0.4.4 |
| Draft as of 2024-08-18 | *Computable Name*:HIVIND18 |
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: HIV.IND.18.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#hivind18logic-initial-population)
* Knowledge Artifact Metadata: Measure Population
  * ?: **ID**: HIV.IND.18.MP**Description**:Measure Population**Logic Definition**:[Measure Population](#hivind18logic-measure-population)
* Knowledge Artifact Metadata: Measure Observation
  * ?: **ID**: HIV.IND.18.MO**Description**:Measure Observation**Logic Definition**:[Measure Observation](#hivind18logic-measure-observation)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: HIV.IND.18.S
* Knowledge Artifact Metadata: Measure Logic
* Knowledge Artifact Metadata: Primary Library
  * ?: [HIV.IND.18 Logic](Library-HIVIND18Logic.md)
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
* Knowledge Artifact Metadata: ````/* End of Other E.DE70 */ /* @dataElement: HIV.E.DE85 - ANC contact date @activity: HIV.E1 Capture or update mother's history @description: The date and time of the client's ANC contact (in the ANC DAK this is called 'Contact date') */ define "ANC contact date E.DE85": exists(Elements."ANC contact date E.DE85" E where E during "Measurement Period")````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
* Knowledge Artifact Metadata: ````define anc: case when "ANC contact date E.DE85" then ConceptsCustom."Antenatal care contact" else null end````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND18Logic
* Knowledge Artifact Metadata: ````define "Stratification": HIE."By Administrative Gender Stratifier".code + ':' + HIE."By Age Stratifier 2" + ':' + HIE."By Geographic Region Stratifier" + Combine(HIE.patientGroups, ':') + ':' + HIE."anc".code````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVElements
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND18Logic
* Knowledge Artifact Metadata: ````define "Measure Population": HIE."Has HIV-positive Status"````
* Knowledge Artifact Metadata:  Logic Definition
