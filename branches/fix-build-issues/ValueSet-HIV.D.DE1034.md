...
| Active as of 2026-03-03 | *Computable Name*:HIVDDE1034 |
...
##### TB preventive treatment (TPT) status ValueSet Schema API

JSON Schema for TB preventive treatment (TPT) status ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.

**Version:** 1.0.0

## Endpoints

### GET /ValueSet-HIV.D.DE1034.schema.json

#### JSON Schema definition for the enumeration ValueSet-HIV.D.DE1034

This endpoint serves the JSON Schema definition for the enumeration ValueSet-HIV.D.DE1034.

## Schema Definition

### ValueSet-HIV.D.DE1034

**Description:** JSON Schema for TB preventive treatment (TPT) status ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.
