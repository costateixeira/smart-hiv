# HIV.IND.67 Syphilis treatment coverage, HIV-positive clients - WHO SMART Guidelines - HIV v0.4.4
...
## Measure: HIV.IND.67 Syphilis treatment coverage, HIV-positive clients (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/Measure/HIVIND67 | *Version*:0.4.4 |
| Draft as of 2024-08-18 | *Computable Name*:HIVIND67 |
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: HIV.IND.67.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#hivind67logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: HIV.IND.67.DEN**Description**:Number of people living with HIV who tested positive for syphilis during the reporting period**Logic Definition**:[Denominator](#hivind67logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: HIV.IND.67.NUM**Description**:Number of people living with HIV who tested positive for syphilis and were treated based on national guidelines during the reporting period**Logic Definition**:[Numerator](#hivind67logic-numerator)
* Knowledge Artifact Metadata: Measure Logic
* Knowledge Artifact Metadata: Primary Library
  * ?: [HIV.IND.67 Logic](Library-HIVIND67Logic.md)
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND67Logic
* Knowledge Artifact Metadata: ````/** * Numerator * * Definition: Number of people living with HIV who tested positive for syphilis and were treated based on national guidelines during the reporting period * Calculation: COUNT of clients with "HIV status"='HIV-positive' AND "Syphilis test date" in the reporting period AND "Syphilis test result"=Positive' AND "Syphilis treatment start date" in the reporting period */ define "Numerator": HIE."Has HIV-positive Status" and exists(HE."Positive B.DE251" S with HE."Syphilis test date B.DE249" P such that S.partOf.references(P) and P.performed.toInterval() during "Measurement Period") and HIE."Syphilis treatment start date B.DE254"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND67Logic
* Knowledge Artifact Metadata: ````/** * Denominator * * Definition: Number of people living with HIV who tested positive for syphilis during the reporting period * Calculation: COUNT of clients with "HIV status"='HIV-positive' AND "Syphilis test date" in the reporting period AND "Syphilis test result"='Positive' */ define "Denominator": HIE."Has HIV-positive Status" and exists(HE."Positive B.DE251" S with HE."Syphilis test date B.DE249" P such that S.partOf.references(P) and P.performed.toInterval() during "Measurement Period")````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND67Logic
