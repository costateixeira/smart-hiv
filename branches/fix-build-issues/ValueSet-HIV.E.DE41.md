...
| Active as of 2026-03-03 | *Computable Name*:HIVEDE41 |
...
##### Timing of ART initiation ValueSet Schema API

JSON Schema for Timing of ART initiation ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.

**Version:** 1.0.0

## Endpoints

### GET /ValueSet-HIV.E.DE41.schema.json

#### JSON Schema definition for the enumeration ValueSet-HIV.E.DE41

This endpoint serves the JSON Schema definition for the enumeration ValueSet-HIV.E.DE41.

## Schema Definition

### ValueSet-HIV.E.DE41

**Description:** JSON Schema for Timing of ART initiation ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.
