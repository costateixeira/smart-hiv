# HIV.IND.64 Syphilis test positivity, pregnant women, first visit - WHO SMART Guidelines - HIV v0.4.4
...
## Measure: HIV.IND.64 Syphilis test positivity, pregnant women, first visit (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/Measure/HIVIND64 | *Version*:0.4.4 |
| Draft as of 2024-08-18 | *Computable Name*:HIVIND64 |
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: HIV.IND.64.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#hivind64logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: HIV.IND.64.DEN**Description**:Number of pregnant women tested for syphilis while attending first ANC services visit during the reporting period**Logic Definition**:[Denominator](#hivind64logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: HIV.IND.64.NUM**Description**:Number of pregnant women who tested positive for syphilis on first ANC services visit during the reporting period (tested positive on both nontreponemal and treponemal tests or tested positive on either nontreponemal or treponemal test)**Logic Definition**:[Numerator](#hivind64logic-numerator)
* Knowledge Artifact Metadata: Measure Logic
* Knowledge Artifact Metadata: Primary Library
  * ?: [HIV.IND.64 Logic](Library-HIVIND64Logic.md)
