...
| Active as of 2026-03-03 | *Computable Name*:HIVDDE1002 |
...
##### TB treatment outcome ValueSet Schema API

JSON Schema for TB treatment outcome ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.

**Version:** 1.0.0

## Endpoints

### GET /ValueSet-HIV.D.DE1002.schema.json

#### JSON Schema definition for the enumeration ValueSet-HIV.D.DE1002

This endpoint serves the JSON Schema definition for the enumeration ValueSet-HIV.D.DE1002.

## Schema Definition

### ValueSet-HIV.D.DE1002

**Description:** JSON Schema for TB treatment outcome ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.
