# HIV.IND.81 HBV test coverage, HIV-positive clients - WHO SMART Guidelines - HIV v0.4.4
...
## Measure: HIV.IND.81 HBV test coverage, HIV-positive clients (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/Measure/HIVIND81 | *Version*:0.4.4 |
| Draft as of 2024-08-18 | *Computable Name*:HIVIND81 |
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: HIV.IND.81.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#hivind81logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: HIV.IND.81.DEN**Description**:Number of people living with HIV attending HIV care and treatment services during the reporting period**Logic Definition**:[Denominator](#hivind81logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: HIV.IND.81.NUM**Description**:Number of people living with HIV tested for HBsAg during the reporting period**Logic Definition**:[Numerator](#hivind81logic-numerator)
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND81Logic
* Knowledge Artifact Metadata: ````/** * Numerator * * Definition: Number of people living with HIV tested for HBsAg during the reporting period * Calculation: COUNT of clients with "HIV status"='HIV-positive' AND with "HBsAg test date" in the reporting period */ define "Numerator": HIE."Has HIV-positive Status" and HIE."HBsAg test date D.DE161"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVElements
