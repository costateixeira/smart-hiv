# New antiretroviral regimen after substitution within first-line regimen ValueSet - WHO SMART Guidelines - HIV v0.4.4
...
## ValueSet: New antiretroviral regimen after substitution within first-line regimen ValueSet (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/ValueSet/HIV.D.DE483 | *Version*:0.4.4 |
| Active as of 2026-03-03 | *Computable Name*:HIVDDE483 |
...
```json
{
  ...
  "extension" : [{
    ...
    "valueMarkdown" : "This should be a context-specific list of new antiretroviral (ARV) drugs after client changed regimen within the first-line regimen"
  }],
