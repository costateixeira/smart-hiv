# HIV.IND.77 Presence of STI syndrome, HIV-positive clients - WHO SMART Guidelines - HIV v0.4.4
...
## Measure: HIV.IND.77 Presence of STI syndrome, HIV-positive clients (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/Measure/HIVIND77 | *Version*:0.4.4 |
| Draft as of 2024-08-18 | *Computable Name*:HIVIND77 |
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: HIV.IND.77.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#hivind77logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: HIV.IND.77.DEN**Description**:Number of people living with HIV attending HIV care and treatment services during the reporting period**Logic Definition**:[Denominator](#hivind77logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: HIV.IND.77.NUM**Description**:Number of people living with HIV diagnosed with one or more of the STI syndromes during the reporting period**Logic Definition**:[Numerator](#hivind77logic-numerator)
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND77Logic
* Knowledge Artifact Metadata: ````/** * Numerator * * Definition: Number of people living with HIV diagnosed with one or more of the STI syndromes during the reporting period * Calculation: COUNT of clients with "HIV status"='HIV-positive' AND with "Any STI syndrome diagnosed"=True on a "Visit date" in reporting period */ define "Numerator": HIE."Has HIV-positive Status" and exists(HIE."Syndrome/STI diagnosed B.DE226 Condition" C where exists (HE."Visit date SRV.DE15" t where start of t.toInterval() = start of C.prevalenceInterval()) )````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIndicatorElements
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND77Logic
* Knowledge Artifact Metadata: ````/** * Denominator * * Definition: Number of people living with HIV attending HIV care and treatment services during the reporting period * Calculation: COUNT of clients with "HIV status"='HIV-positive' with a "Visit date" in reporting period */ define "Denominator": HIE."Has HIV-positive Status" and HIE."Visit date SRV.DE15"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND77Logic
