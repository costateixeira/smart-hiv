# HIV.IND.83 HCV test coverage, HIV prevention services - WHO SMART Guidelines - HIV v0.4.4
...
## Measure: HIV.IND.83 HCV test coverage, HIV prevention services (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/Measure/HIVIND83 | *Version*:0.4.4 |
| Draft as of 2024-08-18 | *Computable Name*:HIVIND83 |
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: HIV.IND.83.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#hivind83logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: HIV.IND.83.DEN**Description**:Number of people attending HIV prevention services during the reporting period**Logic Definition**:[Denominator](#hivind83logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: HIV.IND.83.NUM**Description**:Number of people attending HIV prevention services tested for HCV (HCV antibody, HCV RNA or HCV core antigen) during the reporting period**Logic Definition**:[Numerator](#hivind83logic-numerator)
* Knowledge Artifact Metadata: Measure Logic
* Knowledge Artifact Metadata: Primary Library
  * ?: [HIV.IND.83 Logic](Library-HIVIND83Logic.md)
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Observation**Profile(s)**:[Observation](http://hl7.org/fhir/R4/observation.html)**Must Support Elements**: code, status, effective, effective.low**Code Filter(s)**:**Path**: code**Code**: 
* Knowledge Artifact Metadata: Data Requirement
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND83Logic
* Knowledge Artifact Metadata: ````/** * Numerator * * CALCULATION SHOULD BE MODIFIED TO REFLECT CONTEXT * Definition: Number of people attending HIV prevention services tested for HCV (HCV antibody, HCV RNA or HCV core antigen) during the reporting period * Calculation: COUNT of clients with "HCV test date" in the reporting period */ define "Numerator": exists(HIE."HCV test date D.DE169") and exists(HIE."Date accessed HIV prevention intervention")````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND83Logic
...
```json
{
  ...
  "contained" : [{
    ...
    "dataRequirement" : [{
      ...
      "mustSupport" : ["code", "status", "effective", "effective.low"],
      "codeFilter" : [{
        "path" : "code",
        "code" : [{
          "system" : "http://smart.who.int/hiv/CodeSystem/HIVConcepts",
