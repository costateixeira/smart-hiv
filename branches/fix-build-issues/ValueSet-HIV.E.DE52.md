...
| Active as of 2026-03-03 | *Computable Name*:HIVEDE52 |
...
##### Delivery mode ValueSet Schema API

JSON Schema for Delivery mode ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.

**Version:** 1.0.0

## Endpoints

### GET /ValueSet-HIV.E.DE52.schema.json

#### JSON Schema definition for the enumeration ValueSet-HIV.E.DE52

This endpoint serves the JSON Schema definition for the enumeration ValueSet-HIV.E.DE52.

## Schema Definition

### ValueSet-HIV.E.DE52

**Description:** JSON Schema for Delivery mode ValueSet ValueSet codes. Generated from FHIR expansions using IRI format.
