# Reason for switch to second-line regimen ValueSet - WHO SMART Guidelines - HIV v0.4.4
...
## ValueSet: Reason for switch to second-line regimen ValueSet (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/ValueSet/HIV.D.DE486 | *Version*:0.4.4 |
| Active as of 2026-03-03 | *Computable Name*:HIVDDE486 |
...
```json
{
  ...
  "extension" : [{
    ...
    "valueMarkdown" : "This should be a context-specific list of reason why client was switched from first- to second-line ARV drug regimen"
  }],
