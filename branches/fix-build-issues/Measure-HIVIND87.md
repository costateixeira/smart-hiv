# HIV.IND.87 HBsAg positivity, pregnant women - WHO SMART Guidelines - HIV v0.4.4
...
## Measure: HIV.IND.87 HBsAg positivity, pregnant women (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/Measure/HIVIND87 | *Version*:0.4.4 |
| Draft as of 2024-08-18 | *Computable Name*:HIVIND87 |
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: HIV.IND.87.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#hivind87logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: HIV.IND.87.DEN**Description**:Number of pregnant women tested for HBsAg during the reporting period**Logic Definition**:[Denominator](#hivind87logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: HIV.IND.87.NUM**Description**:Number of pregnant women who tested positive for HBsAg during the reporting period**Logic Definition**:[Numerator](#hivind87logic-numerator)
* Knowledge Artifact Metadata: Measure Logic
* Knowledge Artifact Metadata: Primary Library
  * ?: [HIV.IND.87 Logic](Library-HIVIND87Logic.md)
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVElements
* Knowledge Artifact Metadata: ````define "ANC contact date E.DE85": "Antenatal care contact" E return E.period.toInterval()````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND87Logic
* Knowledge Artifact Metadata: ````/** * Numerator * * Definition: Number of pregnant women who tested positive for HBsAg during the reporting period * Calculation: COUNT of "Currently pregnant" women with "HBsAg test date" on an "ANC contact date" in the reporting period AND "HBsAg test result"='HBsAg positive' */ define "Numerator": HIE."Currently pregnant SRV.DE7" and exists(HE."Positive D.DE163" G with HE."HBsAg test date D.DE161" P such that G.partOf.references(P) and P.performed.toInterval() during "Measurement Period" and exists (HE."ANC contact date E.DE85" E where start of E = start of P.performed.toInterval()))````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND87Logic
* Knowledge Artifact Metadata: ````/** * Denominator * * Definition: Number of pregnant women tested for HBsAg during the reporting period * Calculation: COUNT of "Currently pregnant" women with "HBsAg test date" on an "ANC contact date" in the reporting period */ define "Denominator": HIE."Currently pregnant SRV.DE7" and exists(HE."HBsAg test date D.DE161" P where P.performed.toInterval() during "Measurement Period" and exists (HE."ANC contact date E.DE85" E where start of E = start of P.performed.toInterval()))````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**HIVIND87Logic
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "ANC contact date E.DE85"
      },
      {
        "url" : "statement",
        "valueString" : "define \"ANC contact date E.DE85\":\n  \"Antenatal care contact\" E\n  return E.period.toInterval()"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 7
